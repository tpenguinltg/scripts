...
duplicity --full-if-older-than 3M --verbosity info --asynchronous-upload / --exclude-if-present .nobackup --include /etc --include /var/lib/pacman/local --include /boot --exclude '**' "file://$destination/system"
exit_status=$?
